...
public class TriviaGame {
    public int numQuestionsRight;
    public int numQuestionsWrong;
    public int pointsEarned;
    public int pointsStreak;
    public int pointsStreak2;
     ...
     * @throws java.io.FileNotFoundException Lets us access the file by throwing the FileNotFoundException
     * @return Returns a question class array with all twelve questions read from the file.
     */
    ...
    public int getNumQuestionsRight() {
        return numQuestionsRight;
    }

    public void setNumQuestionsRight(int numQuestionsRight) {
        this.numQuestionsRight = numQuestionsRight;
    }

    public int getNumQuestionsWrong() {
        return numQuestionsWrong;
    }

    public void setNumQuestionsWrong(int numQuestionsWrong) {
        this.numQuestionsWrong = numQuestionsWrong;
    }
    ...
    public int getPointsStreak() {
        return pointsStreak;
    }

    public void setPointsStreak(int pointsStreak) {
        this.pointsStreak = pointsStreak;
    }

    public void setPointsStreak2(int pointsStreak2) {
        this.pointsStreak2 = pointsStreak2;
    }
}
